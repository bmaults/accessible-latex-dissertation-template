...
%% NC State requires most text to be the same size as the body text.
%% Preliminary-page headings should therefore stay at \normalsize unless the
%% Graduate School approves a different style.
...
\IfFileExists{student-macros.tex}{\input{student-macros}}{}
...
\IfFileExists{optional-accessible.tex}{\input{optional-accessible}}{}
...
\include{Chapter-2/Chapter-2-demo}
\include{Chapter-3/Chapter-3-demo}
\include{Chapter-4/Chapter-4-demo}
\include{Chapter-5/Chapter-5-demo}
\include{Chapter-6/Chapter-6-demo}
